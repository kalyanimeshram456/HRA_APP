...
public class PastLeaveAdapter extends RecyclerView.Adapter<PastLeaveAdapter.ViewHolder> {
    ...
    public PastLeaveAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public PastLeaveAdapter(Context context, List<EmployeeList> listData, ListItemSelectListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.row_past_leaves, parent, false);
