...
public class EditCompanyRequest {
    ...
    private RequestBody contact_no;

    @SerializedName("email_id")
    private RequestBody email_id;

    @SerializedName("staff_strength")
    private RequestBody staff_strength;
    ...
    private RequestBody registered_address;
    ...
    public RequestBody getContact_no() {
        return contact_no;
    }

    public void setContact_no(RequestBody contact_no) {
    ...
    public RequestBody getStaff_strength() {
        return staff_strength;
    }

    public void setStaff_strength(RequestBody staff_strength) {
    ...
    public RequestBody getRegistered_address() {
        return registered_address;
    }

    public void setRegistered_address(RequestBody registered_address) {
