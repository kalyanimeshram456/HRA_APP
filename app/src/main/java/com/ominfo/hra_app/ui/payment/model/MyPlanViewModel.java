...
public class MyPlanViewModel extends ViewModel {
    ...
    public MyPlanViewModel(Service service) {
    ...
    public void hitPaymentAPI(RequestBody act,RequestBody company_id
           ) {
        disposables.add(service.executeGetMyPlanDetailsAPI(act,company_id)
