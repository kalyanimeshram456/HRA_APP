...
public class RenewPlanViewModel extends ViewModel {
    ...
    public RenewPlanViewModel(Service service) {
    ...
    public void hitRenewPlanAPI(RequestBody act,RequestBody company_id
           ) {
        disposables.add(service.executeRenewPlanDetailsAPI(act,company_id)
