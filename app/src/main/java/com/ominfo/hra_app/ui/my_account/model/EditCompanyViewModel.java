...
public class EditCompanyViewModel extends ViewModel {
    ...
    public EditCompanyViewModel(Service service) {
    ...
    public void hitEditCompanyAPI(EditCompanyRequest editCompanyRequest) {
        disposables.add(service.executeEditCompanyAPI(editCompanyRequest)
