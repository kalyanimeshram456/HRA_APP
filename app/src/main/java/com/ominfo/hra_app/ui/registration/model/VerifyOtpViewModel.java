...
public class VerifyOtpViewModel extends ViewModel {
    ...
    public VerifyOtpViewModel(Service service) {
    ...
    public void hitVerifyOtpApi(RequestBody action,RequestBody otp,RequestBody text) {

        disposables.add(service.executeVerifyOtpAPI(action,otp,text)
