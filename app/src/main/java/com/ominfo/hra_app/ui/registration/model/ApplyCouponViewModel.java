...
public class ApplyCouponViewModel extends ViewModel {
    ...
    public ApplyCouponViewModel(Service service) {
    ...
    public void hitApplyCouponApi(RequestBody action,RequestBody text) {

        disposables.add(service.executeApplyCouponAPI(action,text)
