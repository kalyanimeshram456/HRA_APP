...
public class GetCompanyList {
    ...
    private String mOfficeLatitude;
    @SerializedName("office_longitude")
    private String mOfficeLongitude;
    ...
    private String mThursEndTime;
    @SerializedName("thurs_start_time")
    private String mThursStartTime;
    @SerializedName("thurs_working")
    private String mThursWorking;
    ...
    public String getThursStartTime() {
        return mThursStartTime;
    }

    public void setThursStartTime(String thursStartTime) {
        mThursStartTime = thursStartTime;
    }

    public String getThursWorking() {
        return mThursWorking;
    }

    public void setThursWorking(String thursWorking) {
