...
public class ApplyLeaveViewModel extends ViewModel {
    ...
    public ApplyLeaveViewModel(Service service) {
    ...
    public void hitApplyLeaveApi(ApplyLeaveRequest applyLeaveRequest) {

        disposables.add(service.executeApplyLeaveAPI(applyLeaveRequest)
