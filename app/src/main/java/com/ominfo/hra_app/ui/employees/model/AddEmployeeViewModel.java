...
public class AddEmployeeViewModel extends ViewModel {
    ...
    public AddEmployeeViewModel(Service service) {
    ...
    public void executeAddEmployeeAPI(AddEmployeeRequest addEmployeeRequest) {
        disposables.add(service.executeAddEmployeeAPI(addEmployeeRequest)
