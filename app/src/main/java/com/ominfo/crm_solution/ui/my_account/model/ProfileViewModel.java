...
public class ProfileViewModel extends ViewModel {
    ...
    public ProfileViewModel(Service service) {
    ...
    public void hitProfileApi(ProfileRequest profileRequest) {

        disposables.add(service.executeProfileAPI(profileRequest)
