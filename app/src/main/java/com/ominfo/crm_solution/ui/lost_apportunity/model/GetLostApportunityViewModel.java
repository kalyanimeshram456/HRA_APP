...
public class GetLostApportunityViewModel extends ViewModel {
    private final CompositeDisposable disposables = new CompositeDisposable();
    private final MutableLiveData<ApiResponse> responseLiveData = new MutableLiveData<>();
    private Service service;


    public GetLostApportunityViewModel(Service service) {
    ...
    public void hitGetLostApportunityApi(GetLostApportunityRequest getEnquiryRequest) {

        disposables.add(service.executeGetLostApportunityAPI(getEnquiryRequest)
