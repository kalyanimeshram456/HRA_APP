...
/*
    ...
    private void init(){
        ...
        setToolbar();
        dashboardList.add(new DashModel("Sales Credit","dispatch",mContext.getDrawable(R.drawable.ic_om_sales_credit)));
        dashboardList.add(new DashModel("Receipt","dispatch",mContext.getDrawable(R.drawable.ic_om_receipt)));
        dashboardList.add(new DashModel("Top Customer","dispatch",mContext.getDrawable(R.drawable.ic_om_rating)));
        dashboardList.add(new DashModel("Total Quotation Amount","dispatch",mContext.getDrawable(R.drawable.ic_om_total_quotation)));
        dashboardList.add(new DashModel("Dispatch Pending","dispatch",mContext.getDrawable(R.drawable.ic_om_dispatch_pending)));
        dashboardList.add(new DashModel("Enquiry Report","dispatch",mContext.getDrawable(R.drawable.ic_om_enquiry_report)));
        dashboardList.add(new DashModel("Visit Report","dispatch",mContext.getDrawable(R.drawable.ic_om_visit_report)));
        //dashboardList.add(new DashModel("Products","dispatch",mContext.getDrawable(R.drawable.ic_om_product)));
        //dashboardList.add(new DashModel("Sales Credit","dispatch",mContext.getDrawable(R.drawable.ic_om_sales_credit)));
        //dashboardList.add(new DashModel("Receipt","dispatch",mContext.getDrawable(R.drawable.ic_om_receipt)));
        //dashboardList.add(new DashModel("Top Customer","dispatch",mContext.getDrawable(R.drawable.ic_om_rating)));
...
*/
    ...
    private void setAdapterForDashboardList() {
        ...
        salesCreditAdapter = new DispatchPendingAdapter(mContext, dashboardList, new DispatchPendingAdapter.ListItemSelectListener() {
            @Override
