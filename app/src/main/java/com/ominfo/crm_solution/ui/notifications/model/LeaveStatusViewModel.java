...
public class LeaveStatusViewModel extends ViewModel {
    ...
    public void hitLeaveStatusRecordApi(RequestBody action, RequestBody id,RequestBody leave_status,
                                        RequestBody updated_by) {

        disposables.add(service.executeLeaveStatusAPI(action,id,leave_status,updated_by)
