...
public class ProfileResult {
    ...
    public String getEmpOfficeNum() {
        return mEmpOfficeNum;
    }

    public void setEmpOfficeNum(String empOfficeNum) {
        mEmpOfficeNum = empOfficeNum;
    }
