...
public class DisaptchViewModel extends ViewModel {
    private final CompositeDisposable disposables = new CompositeDisposable();
    private final MutableLiveData<ApiResponse> responseLiveData = new MutableLiveData<>();
    private Service service;


    public DisaptchViewModel(Service service) {
    ...
    public void hitDisaptchApi(DispatchRequest request) {

        disposables.add(service.executeDispatchAPI(request)
